...
#define UDF_VERSION_NOTICE "v0.7.1"
...
extern struct buffer_head *udf_read_tagged(struct super_block *, Uint32, int);
extern struct buffer_head *udf_read_untagged(struct super_block *, Uint32, int);
...
extern int udf_translate_to_linux(struct ustr *, struct ustr *);
